...
#ifndef XLA_HLO_TRANSFORMS_FUSION_CONSTANT_SINKING_H_
#define XLA_HLO_TRANSFORMS_FUSION_CONSTANT_SINKING_H_
...
#endif  // XLA_HLO_TRANSFORMS_FUSION_CONSTANT_SINKING_H_
