...
#ifndef XLA_HLO_TRANSFORMS_CONVOLUTION_GROUP_CONVERTER_H_
#define XLA_HLO_TRANSFORMS_CONVOLUTION_GROUP_CONVERTER_H_
...
#endif  // XLA_HLO_TRANSFORMS_CONVOLUTION_GROUP_CONVERTER_H_
