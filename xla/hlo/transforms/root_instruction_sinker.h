...
#ifndef XLA_HLO_TRANSFORMS_ROOT_INSTRUCTION_SINKER_H_
#define XLA_HLO_TRANSFORMS_ROOT_INSTRUCTION_SINKER_H_
...
#endif  // XLA_HLO_TRANSFORMS_ROOT_INSTRUCTION_SINKER_H_
