...
#ifndef XLA_HLO_TRANSFORMS_HLO_REMATERIALIZATION_TEST_UTILS_H_
#define XLA_HLO_TRANSFORMS_HLO_REMATERIALIZATION_TEST_UTILS_H_
...
#endif  // XLA_HLO_TRANSFORMS_HLO_REMATERIALIZATION_TEST_UTILS_H_
