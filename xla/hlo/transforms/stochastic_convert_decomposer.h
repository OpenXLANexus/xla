...
#ifndef XLA_HLO_TRANSFORMS_STOCHASTIC_CONVERT_DECOMPOSER_H_
#define XLA_HLO_TRANSFORMS_STOCHASTIC_CONVERT_DECOMPOSER_H_
...
#endif  // XLA_HLO_TRANSFORMS_STOCHASTIC_CONVERT_DECOMPOSER_H_
