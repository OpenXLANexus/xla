...
#ifndef XLA_HLO_TRANSFORMS_OPTIMIZE_INPUT_OUTPUT_BUFFER_ALIAS_H_
#define XLA_HLO_TRANSFORMS_OPTIMIZE_INPUT_OUTPUT_BUFFER_ALIAS_H_
...
#endif  // XLA_HLO_TRANSFORMS_OPTIMIZE_INPUT_OUTPUT_BUFFER_ALIAS_H_
