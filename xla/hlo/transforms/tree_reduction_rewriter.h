...
#ifndef XLA_HLO_TRANSFORMS_TREE_REDUCTION_REWRITER_H_
#define XLA_HLO_TRANSFORMS_TREE_REDUCTION_REWRITER_H_
...
#endif  // XLA_HLO_TRANSFORMS_TREE_REDUCTION_REWRITER_H_
