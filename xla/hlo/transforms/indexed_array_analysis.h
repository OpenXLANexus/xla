...
#ifndef XLA_HLO_TRANSFORMS_INDEXED_ARRAY_ANALYSIS_H_
#define XLA_HLO_TRANSFORMS_INDEXED_ARRAY_ANALYSIS_H_
...
#endif  // XLA_HLO_TRANSFORMS_INDEXED_ARRAY_ANALYSIS_H_
