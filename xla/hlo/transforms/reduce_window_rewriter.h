...
#ifndef XLA_HLO_TRANSFORMS_REDUCE_WINDOW_REWRITER_H_
#define XLA_HLO_TRANSFORMS_REDUCE_WINDOW_REWRITER_H_
...
#endif  // XLA_HLO_TRANSFORMS_REDUCE_WINDOW_REWRITER_H_
