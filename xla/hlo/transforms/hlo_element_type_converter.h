...
#ifndef XLA_HLO_TRANSFORMS_HLO_ELEMENT_TYPE_CONVERTER_H_
#define XLA_HLO_TRANSFORMS_HLO_ELEMENT_TYPE_CONVERTER_H_
...
#endif  // XLA_HLO_TRANSFORMS_HLO_ELEMENT_TYPE_CONVERTER_H_
